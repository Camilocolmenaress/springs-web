          ...
          >
            ...
            >
              <svg viewBox="0 0 110 110" width="100%" height="100%">
                <circle cx="55" cy="55" r={_gr} fill="none" stroke="rgba(242,232,213,0.4)" strokeWidth="1.2" opacity={0.8}/>
                <motion.g
                  animate={{ rotate: 360 }}
                  transition={{ duration: 12, repeat: Infinity, ease: "linear" }}
                  style={{ transformBox: "fill-box", transformOrigin: "center" }}
                >
                  <ellipse cx="55" cy="55" rx={+(_gr*0.36).toFixed(1)} ry={_gr} fill="none" stroke="rgba(242,232,213,0.4)" strokeWidth="0.9" opacity={0.6}/>
                  <ellipse cx="55" cy="55" rx={+(_gr*0.77).toFixed(1)} ry={_gr} fill="none" stroke="rgba(242,232,213,0.4)" strokeWidth="0.9" opacity={0.5}/>
                  <ellipse cx="55" cy="55" rx={_gr} ry={+(_gr*0.41).toFixed(1)} fill="none" stroke="rgba(242,232,213,0.4)" strokeWidth="0.9" opacity={0.6}/>
                  <ellipse cx="55" cy="55" rx={_gr} ry={+(_gr*0.77).toFixed(1)} fill="none" stroke="rgba(242,232,213,0.4)" strokeWidth="0.8" opacity={0.45}/>
                  <line x1={55-_gr} y1="55" x2={55+_gr} y2="55" stroke="rgba(242,232,213,0.4)" strokeWidth="0.8" opacity={0.45}/>
                  <line x1="55" y1={55-_gr} x2="55" y2={55+_gr} stroke="rgba(242,232,213,0.4)" strokeWidth="0.8" opacity={0.45}/>
                </motion.g>
                <path id="home-chimba-circle" fill="none" d={`M${_gsx},${_gsy} a${_tr},${_tr} 0 0,1 ${_tr},${-_gdy} a${_tr},${_tr} 0 0,1 ${-_tr},${_gdy}`}/>
                <text fontFamily="JetBrains Mono, monospace" fontSize={d.globeFontSize} letterSpacing="1.0" fill="rgba(242,232,213,0.4)" fillOpacity={0.9}>
